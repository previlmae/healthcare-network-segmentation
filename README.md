...
└── 📁 evidence/
    ├── 🖼️  Fig1_VLAN_Creation.png
    ├── 🖼️  Fig2_VLAN_IP_Addresses.png
    ├── 🖼️  Fig3_DHCP_Configuration.png
    ├── 🖼️  Fig4_PCAdmin_DHCP.png
    ├── 🖼️  Fig5_PCClinical_DHCP.png
    ├── 🖼️  Fig6_EHRServer_DHCP.png
    ├── 🖼️  Fig7_ACL_Configuration.png
    ├── 🖼️  Fig8_Guest_Isolation_Test.png  ← 100% packet loss ✅
    └── 🖼️  Fig9_Clinical_Access_Test.png  ← 0% packet loss ✅
